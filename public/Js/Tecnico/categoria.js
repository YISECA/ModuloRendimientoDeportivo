$(function()
{
	...
	$('#a_edicar').on('click', function(e)
	{
			...
			var Id_ct=$('select[name="Id_ct"]').val();
			if(Id_ct==""){
				...
				$.get(
		            ...
		            function(data)
		            {
		                if(data)
		                {
		                   $('#nom_ct').val(data.Nombre_Categoria);
		                   $('#id_Ct').val(data.Id);
		                }
		            },
		            'json'
			...
			$.ajax({
	            ...
	            success: function(data){
					...
					{			
						...
						$("#div_mensaje2").html("<strong>Se ha registrado exitosamente la categoria: </strong> "+data.Nombre_Categoria); 
						$('#div_mensaje2').fadeIn();
						setTimeout(function(){
							$('#div_mensaje2').fadeOut(); 
						}, 2500)  
			    ...
			    $.get(
		            ...
		            function(data)
		            {
		                if(data.status == 'True')
		                {
		                    ...
		                    $("#div_mensaje2").removeClass("alert alert-danger");
							$("#div_mensaje2").addClass("alert alert-success");	
							$("#div_mensaje2").html("<strong>Categoria eliminada con exíto."); 
							$('#div_mensaje2').fadeIn();
							setTimeout(function(){
								$('#div_mensaje2').fadeOut(); 
							}, 2500) 
		                ...
		                else
		                {
							...
							$("#div_mensaje2").addClass("alert alert-danger");	
							$("#div_mensaje2").html("<strong>No se elimino la categoria, por favor averiguar con el encargado del sistema."); 
							setTimeout(function(){
								$('#div_mensaje2').fadeOut(); 
							}, 2500) 
		                }
